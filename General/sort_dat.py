...
# file='/Users/jackcheng/Documents/AE_Master/Experimetal_simulation/BAL.mat'
# file_p='/Users/jackcheng/Documents/AE_Master/Experimetal_simulation/PRS_dat.mat'
file = get_file_path("BAL.mat")
file_p = get_file_path("PRS_dat.mat")
...
bal_sorted1 = final_sort(sort1(delta_0))
bal_sorted2 = final_sort(sort1(delta_15))
bal_sorted3 = final_sort(sort1(delta_neg15))
