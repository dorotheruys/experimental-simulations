...
% been implemented.
fn_BAL = {'BAL/raw_group19delta_neg15_2.txt'};
...
fn0 = {'BAL/zer_ 20240229-092428.txt'}; 
   
% filenames of the pressure data files (same comments apply as for balance 
% data files)
fn_PRS = {'PRESSURE/raw_group19delta_neg15_2.txt'};
...
figure
plot(BAL.windOn.group19delta_neg15_2.AoA,BAL.windOn.group19delta_neg15_2.CL,'*b')